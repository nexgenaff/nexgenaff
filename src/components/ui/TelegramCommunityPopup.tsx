...
export default function TelegramCommunityPopup({ onClose }: TelegramCommunityPopupProps) {
  return (
    <div className="fixed inset-0 z-[9999] flex justify-center bg-black/70 px-3 pt-3 pb-4 backdrop-blur-sm" onClick={onClose}>
      <div
        className="relative mt-1 w-full max-w-[420px] rounded-[24px] border border-cyan-400/20 bg-[linear-gradient(145deg,#1a1a2e,#16213e)] p-5 shadow-[0_20px_70px_rgba(0,0,0,0.7)]"
      ...
      >
        ...
        <div className="mb-4 flex justify-center">
          <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-[linear-gradient(135deg,#0088cc,#005f8a)] shadow-[0_10px_35px_rgba(0,136,204,0.35)]">
        ...
        <h2 className="mb-2 text-center text-[22px] font-semibold tracking-[-0.3px] text-white">
          Join <span className="bg-[linear-gradient(135deg,#0088cc,#00b4ff)] bg-clip-text text-transparent">Afficixo</span> Community
        </h2>

        <p className="mb-1 text-center text-[13px] leading-6 text-slate-400">
        ...
        <div className="mt-4 grid grid-cols-2 gap-2">
          {[
            ...
            <div key={item.title} className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/10 p-2.5">
        ...
        <a
          ...
          className="relative mt-4 flex w-full items-center justify-center gap-2 overflow-hidden rounded-xl bg-[linear-gradient(135deg,#0088cc,#006699)] px-3 py-3 text-[13px] font-semibold text-white shadow-[0_8px_25px_rgba(0,136,204,0.3)] transition-all hover:-translate-y-0.5 hover:bg-[linear-gradient(135deg,#0099dd,#0077aa)] hover:shadow-[0_10px_30px_rgba(0,136,204,0.35)]"
        >
        ...
        <button
          type="button"
          onClick={onClose}
          className="mt-2 w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-[12px] text-slate-300 transition-colors hover:bg-white/10 hover:text-white"
        >
          Maybe later
        </button>
      </div>
