    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-transparent p-4" onClick={onClose}>
      ...
      >
        <button
          ...
          className="absolute right-3.5 top-3.5 flex h-9 w-9 items-center justify-center rounded-full border border-white/10 bg-white/5 text-slate-400 transition-all hover:-rotate-90 hover:bg-white/10 hover:text-white"
        >
          <X className="h-4.5 w-4.5" />
        </button>

        <div className="mb-5 flex justify-center">
          <div className="relative flex h-20 w-20 items-center justify-center rounded-full bg-[linear-gradient(135deg,#0088cc,#005f8a)] shadow-[0_12px_40px_rgba(0,136,204,0.3)]">
        ...
        <h2 className="mb-2 text-center text-2xl font-semibold tracking-[-0.3px] text-white">
          Join <span className="bg-[linear-gradient(135deg,#0088cc,#00b4ff)] bg-clip-text text-transparent">Afficixo</span> Community
        </h2>

        <p className="mb-1 text-center text-sm leading-6 text-slate-400">
        ...
        <div className="mt-6 grid grid-cols-2 gap-2.5">
          {[
            ...
            <div key={item.title} className="flex items-center gap-2.5 rounded-2xl border border-white/5 bg-white/5 p-3">
              <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-white/10 text-sm">
                {item.icon}
              </div>
              <div>
        ...
        <a
          ...
          className="relative mt-6 flex w-full items-center justify-center gap-3 overflow-hidden rounded-2xl bg-[linear-gradient(135deg,#0088cc,#006699)] px-4 py-4 text-sm font-semibold text-white shadow-[0_8px_30px_rgba(0,136,204,0.25)] transition-all hover:-translate-y-0.5 hover:bg-[linear-gradient(135deg,#0099dd,#0077aa)] hover:shadow-[0_12px_40px_rgba(0,136,204,0.35)]"
        >
        ...
        <button
          type="button"
          onClick={onClose}
          className="mt-3 w-full rounded-xl border border-transparent bg-transparent px-3 py-2 text-sm text-slate-500 transition-colors hover:text-slate-300"
        >
          Maybe later
        </button>
      </div>
