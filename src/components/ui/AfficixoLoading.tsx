...
export default function AfficixoLoading({
  ...
  return (
    <div
      className={`flex items-center justify-center ${compact ? "min-h-[260px]" : "min-h-screen"} bg-[#05070b] ${className}`}
    >
      <div className="flex scale-[0.7] flex-col items-center justify-center gap-7">
        ...
        >
          ...
          />
          <motion.div
            className="absolute inset-0 rounded-[18px] bg-gradient-to-r from-indigo-500/35 via-violet-500/24 to-transparent blur-xl"
