    ...
    <header className="bg-white/5 backdrop-blur-xl border-b border-white/10 px-4 sm:px-6 py-3 sm:py-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <h2 className="text-base sm:text-lg font-semibold text-white truncate hidden sm:block">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button className="p-2 rounded-xl hover:bg-white/5 transition text-white/30 hover:text-white/60 relative">
