...
import { CheckCircle2, Copy, Database, MessageCircle, RefreshCw, Webhook, XCircle } from "lucide-react";
...
export default function PostbackTools() {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-8">
      ...
      <section className="border-b border-slate-800 pb-6">
        <div className="mb-4 flex items-center gap-2"><MessageCircle className="h-5 w-5 text-cyan-300" /><h2 className="text-sm font-semibold text-slate-300">Telegram notifications</h2></div>
